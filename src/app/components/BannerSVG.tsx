    ...
    return (
        <>
            <div className={styles.svgContainer}>
                <div className={styles.svgField}>
                    <div className={`${styles.svgItem} ${styles.svgFieldIntroduce}`}>
                    ...
                    <div className={`${styles.svgItem} ${styles.svgFieldContact}`}>
                        <div className={styles.header}>
                            <SettingIconComponent/>
                            <h2>Contact</h2>
                            <ArrowComponent/>
                    ...
                    <div className={`${styles.svgItem} ${styles.svgKnowledge}`}>
                        <div className={styles.header}>
                            <SettingIconComponent/>
                            <h2>My knowledge</h2>
                            <ArrowComponent/>
                        ...
                        <div className={styles.content}><code><span
                            ...
                            className={styles.string}>&quot;JavaScript&quot;</span>,<br/><span
                            className={styles.string}>&quot;React&quot;</span>,<span
